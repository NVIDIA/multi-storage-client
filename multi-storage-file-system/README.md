...
| inode_map_keys_per_page_max                    | decimal              |                       64 | Max number of inodes per page in the B+Tree mapping inode number to the corresponding inode (must be >0 and a a multiple of 2)                                                                                      |
| inode_map_page_evict_low_limit                 | decimal              |                      200 | Paging out of inode B+Tree pages will cease once the number of in memory pages reaches this number                                                                                                                  |
| inode_map_page_evict_high_limit                | decimal              |                      210 | Paging out of inode B+Tree pages will begin once the number of in memory pages reaches this number                                                                                                                  |
| inode_eviction_queue_keys_per_page_max         | decimal              |                      256 | Max number of inode eviction time entries per page in the B+Tree indicating when inodes expire (must be >0 and a a multiple of 2)                                                                                   |
| inode_eviction_queue_page_evict_low_limit      | decimal              |                       50 | Paging out of inode eviction time B+Tree pages will cease once the number of in memory pages reaches this number                                                                                                    |
| inode_eviction_queue_page_evict_high_limit     | decimal              |                       60 | Paging out of inode eviction time B+Tree pages will begin once the number of in memory pages reaches this number                                                                                                    |
| phys_child_dir_entry_map_keys_per_page_max     | decimal              |                       64 | Max number of physical directory entries per page in the B+Tree mapping child inode basenames to inode numbers (must be >0 and a a multiple of 2)                                                                   |
...
| virt_child_dir_entry_map_keys_per_page_max     | decimal              |                       64 | Max number of virtual directory entries per page in the B+Tree mapping child inode basenames to inode numbers (must be >0 and a a multiple of 2)                                                                    |
