...
// Pin k8s.io transitive deps to the versions validated with MSFS.
// Without these replaces, `go mod tidy` may resolve to newer cached
// Kubernetes closures that have not been vetted here yet.
replace (
