...
//    As we will use a locally patched AIStore, we need
//    to temporarily comment out the `gomoddirectives`
//    line in .golangci.yml (that prohibits this)
replace github.com/NVIDIA/aistore => /aistore
