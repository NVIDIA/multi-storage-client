...
var globalsLockMaxHoldBySite = map[string]globalsLockSiteStats{
	...
	"cache.go:396:3:allocateDataCacheLines":                                  {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"cache.go:444:2:(*dataCacheLineTrackerStruct).fetch":                     {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"cache.go:476:2:(*dataCacheLineTrackerStruct).fetch":                     {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1046:3:(*globalsStruct).DoRead":                              {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1137:4:(*globalsStruct).DoRead":                              {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1331:2:(*globalsStruct).DoStatFS":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1369:3:funcLit@1367":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1388:2:(*globalsStruct).DoRelease":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1528:3:funcLit@1526":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1547:2:(*globalsStruct).DoOpenDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:160:3:funcLit@158":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1688:3:funcLit@1681":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1726:2:(*globalsStruct).DoReadDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:179:2:(*globalsStruct).DoLookup":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1849:4:(*globalsStruct).DoReadDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1965:3:funcLit@1963":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1984:2:(*globalsStruct).DoReleaseDir":                        {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2089:3:funcLit@2087":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2108:2:(*globalsStruct).DoCreate":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2310:3:funcLit@2303":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2350:2:(*globalsStruct).DoReadDirPlus":                       {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2635:4:(*globalsStruct).DoReadDirPlus":                       {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2772:3:funcLit@2770":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2791:2:(*globalsStruct).DoStatX":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:301:3:funcLit@299":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:320:2:(*globalsStruct).DoGetAttr":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:441:3:funcLit@439":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:460:2:(*globalsStruct).DoMkDir":                              {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:564:3:funcLit@562":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:583:2:(*globalsStruct).DoUnlink":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:680:3:funcLit@678":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:699:2:(*globalsStruct).DoRmDir":                              {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:846:3:funcLit@844":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:865:2:(*globalsStruct).DoOpen":                               {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:982:3:funcLit@980":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	...
	"fs.go:1104:2:prefetchDirectory":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fs.go:1133:3:prefetchDirectory":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fs.go:123:2:drainFS":                                                    {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fs.go:1299:2:dumpFS":                                                    {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fs.go:1463:2:(*inodeStruct).finishPendingDelete":                        {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
