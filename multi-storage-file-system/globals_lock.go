...
var globalsLockMaxHoldBySite = map[string]globalsLockSiteStats{
	...
	"fission.go:1032:3:(*globalsStruct).DoRead":                              {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1222:2:(*globalsStruct).DoStatFS":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1260:3:funcLit@1258":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1279:2:(*globalsStruct).DoRelease":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1419:3:funcLit@1417":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1438:2:(*globalsStruct).DoOpenDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:152:3:funcLit@150":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1571:3:funcLit@1564":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1609:2:(*globalsStruct).DoReadDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:171:2:(*globalsStruct).DoLookup":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1732:4:(*globalsStruct).DoReadDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1848:3:funcLit@1846":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1867:2:(*globalsStruct).DoReleaseDir":                        {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1972:3:funcLit@1970":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1991:2:(*globalsStruct).DoCreate":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2193:3:funcLit@2186":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2233:2:(*globalsStruct).DoReadDirPlus":                       {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2356:4:(*globalsStruct).DoReadDirPlus":                       {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2493:3:funcLit@2491":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2512:2:(*globalsStruct).DoStatX":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:293:3:funcLit@291":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:312:2:(*globalsStruct).DoGetAttr":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:433:3:funcLit@431":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:452:2:(*globalsStruct).DoMkDir":                              {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:556:3:funcLit@554":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:575:2:(*globalsStruct).DoUnlink":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:672:3:funcLit@670":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:691:2:(*globalsStruct).DoRmDir":                              {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:838:3:funcLit@836":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:857:2:(*globalsStruct).DoOpen":                               {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:972:3:funcLit@970":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
