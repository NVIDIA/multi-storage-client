...
var globalsLockMaxHoldBySite = map[string]globalsLockSiteStats{
	...
	"fission.go:1200:2:(*globalsStruct).DoStatFS":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1238:3:funcLit@1236":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1257:2:(*globalsStruct).DoRelease":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:137:3:funcLit@135":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1397:3:funcLit@1395":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1416:2:(*globalsStruct).DoOpenDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1549:3:funcLit@1542":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:156:2:(*globalsStruct).DoLookup":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1587:2:(*globalsStruct).DoReadDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1710:4:(*globalsStruct).DoReadDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1826:3:funcLit@1824":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1845:2:(*globalsStruct).DoReleaseDir":                        {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1950:3:funcLit@1948":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1969:2:(*globalsStruct).DoCreate":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2171:3:funcLit@2164":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2211:2:(*globalsStruct).DoReadDirPlus":                       {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2334:4:(*globalsStruct).DoReadDirPlus":                       {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2471:3:funcLit@2469":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2490:2:(*globalsStruct).DoStatX":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
