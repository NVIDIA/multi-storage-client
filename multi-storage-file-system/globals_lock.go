...
var globalsLockMaxHoldBySite = map[string]globalsLockSiteStats{
	...
	"fission.go:1178:2:(*globalsStruct).DoStatFS":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1216:3:funcLit@1214":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1235:2:(*globalsStruct).DoRelease":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1375:3:funcLit@1373":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:137:3:funcLit@135":                                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1394:2:(*globalsStruct).DoOpenDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1527:3:funcLit@1520":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1565:2:(*globalsStruct).DoReadDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:156:2:(*globalsStruct).DoLookup":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1688:4:(*globalsStruct).DoReadDir":                           {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1804:3:funcLit@1802":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1823:2:(*globalsStruct).DoReleaseDir":                        {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1928:3:funcLit@1926":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:1947:2:(*globalsStruct).DoCreate":                            {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2149:3:funcLit@2142":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2189:2:(*globalsStruct).DoReadDirPlus":                       {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2312:4:(*globalsStruct).DoReadDirPlus":                       {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2449:3:funcLit@2447":                                         {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission.go:2468:2:(*globalsStruct).DoStatX":                             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	...
	"fission.go:995:3:(*globalsStruct).DoRead":                               {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission_test.go:1212:2:TestFissionDoUnlinkRollbackOnBackendFailure":     {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission_test.go:1602:2:TestFissionConvertPhysicalToVirtual":             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission_test.go:1628:2:TestFissionConvertPhysicalToVirtual":             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission_test.go:1664:2:TestFissionConvertPhysicalToVirtual":             {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission_test.go:445:2:TestFissionDoGetAttrStatX":                        {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"fission_test.go:625:2:TestFissionDoOpenDirReadDirReadDirPlusReleaseDir": {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
