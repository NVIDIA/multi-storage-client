...
var globalsLockMaxHoldBySite = map[string]globalsLockSiteStats{
	...
	"cache.go:244:2:(*cacheLineStruct).fetch":                                {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"cache.go:275:3:(*cacheLineStruct).fetch":                                {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
	"cache.go:293:2:(*cacheLineStruct).fetch":                                {HoldCnt: 0, HoldSum: 0, HoldMax: 0},
