...
buildGoModule (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-GEO8+r9gPqLXPcsQ19SMT3qMq5Y2KaTvkFJP1pDphvo=";
  };
  ...
  #
  # https://github.com/NVIDIA/aistore/tree/v1.4.6/cmd
  subPackages = [
    "cmd/aisinit"
    "cmd/aisloader"
    "cmd/aisnode"
  ...
  #
  # https://github.com/NVIDIA/aistore/blob/v1.4.6/Makefile#L86
  ldflags = [
  ...
  tags = [
    # Monotonic time.
    #
    # https://github.com/NVIDIA/aistore/blob/v1.4.6/Makefile#L98
    "mono"
  ];
